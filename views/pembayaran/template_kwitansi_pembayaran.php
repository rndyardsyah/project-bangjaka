...
$margins1 ='';
$margins2 ='margin-top: 40px';
$margins3 ='height="105px"';
if($data->kategori == 1){
	$margins1 = 'style="margin-top: 80px;"';
	$margins2 = 'margin-top: 20px';
	$margins3 = 'height="70px"';
}
?>
<body id="template_kwitansi_pembayaran" <?php echo $margins1; ?>>		
		...
		<?php }?>
			...
			<div style="padding: 10px;">
				...
				<table id="table_kwitansi_pembayaran" class="pertama" id="RENDY" width="100%" style="border-collapse: collapse; padding-top: 20px; padding-bottom: 5px;">
					<tr>
					...
					<tr>
						<td id="td_kwitansi_pembayaran"></td>
						<td id="td_kwitansi_pembayaran"></td>
						<td id="td_kwitansi_pembayaran">Kegiatan <?php echo @$data_pembayaran[0]->nama_kegiatan; ?></td>
					</tr>
					<tr>
						<td id="td_kwitansi_pembayaran"></td>
						<td id="td_kwitansi_pembayaran"></td>
					...
					<tr>
						<td id="td_kwitansi_pembayaran"></td>
						<td id="td_kwitansi_pembayaran"></td>		
						<td id="td_kwitansi_pembayaran"style="vertical-align : middle;"><div class="full" style="font-size: 14pt; font-weight: bold;">&nbsp;Rp.<?php echo @number_format($total_pembayaran , 0 ,'' , '.').',-'; ?></div><br></td>
					</tr>
					<tr>
						<td id="td_kwitansi_pembayaran"></td>
						<td id="td_kwitansi_pembayaran"></td>
				...
				<table id="table_kwitansi_pembayaran" border="0" style="text-align: center; font-size: 9pt; <?php echo $margins2; ?>" width="100%">
					<tr style="font-weight: bold;">
						<td id="td_kwitansi_pembayaran" width="35%">PPTK,</td>
						<td id="td_kwitansi_pembayaran" width="25%"></td>
						<td id="td_kwitansi_pembayaran" width="40%">Penyedia Barang/ Jasa,
					...
					<tr>
						<td id="td_kwitansi_pembayaran" height="25px"></td>
						<td id="td_kwitansi_pembayaran"></td>
						<td id="td_kwitansi_pembayaran"></td>
					</tr>
					<tr>
