	...
	<div id="batas-margin">	
		...
		<table id="table_template_bapembayaran" width="100%" style="border-collapse: collapse;" align="center">
			...
			<tr>
				...
				<td id="td_template_bapembayaran" width="35%" class="kanan"><span class="<?php if(@$data_pembayaran[0]->nomor_kosong == '0'){ echo 'nomor_kosong';} ?>"><?php echo @$data_pembayaran[0]->no_ba_pembayaran; ?></span></td>
			</tr>
			<tr>
		...
		<table id="table_template_bapembayaran" border="0" width="100%" style="border-collapse: collapse; padding-top: 5px; padding-bottom: 5px;">
			...
			<tr>
				...
				<td id="td_template_bapembayaran">:</td>
				<td id="td_template_bapembayaran"><?php echo @$data_pembayaran[0]->nomenklatur_jabatan_pengguna_anggaran; ?> <?php echo ucwords(getNamaUnor(substr(@$data_pembayaran[0]->kode_unor,0,5))); ?></td>
			</tr>
			<tr >
				<td></td>
			...
			<tr>
				...
				<td id="td_template_bapembayaran">:</td>
				<td id="td_template_bapembayaran"><?php echo strtoupper(@$data_pembayaran[0]->nama_penyedia); ?></td>
			</tr>
			<tr>
				<td id="td_template_bapembayaran"></td>
				<td id="td_template_bapembayaran">Jabatan</td>
			...
			<tr>
				...
				<td id="td_template_bapembayaran">:</td>
				<td id="td_template_bapembayaran"><?php echo ucwords(strtolower(@$data_pembayaran[0]->alamat)); ?></td>
			</tr>
			<tr >
				<td id="td_template_bapembayaran"></td>
				  ...
				  <ol type="a">
					  ...
					  <table width="100%" border="0"  style="font-size: 10pt">
						...
						<tr>
							...
							<td></td>
							<td></td>
							<td valign="top">Waktu Pelaksanaan</td>
							<td valign="top">:</td>
							<td valign="top"><?php echo @$data_pembayaran[0]->waktu_pelaksanaan; ?></td>
						</tr>
						<?php
							$nomers = 1;
						...
						<tr>
							...
							<td valign="top">Waktu Pelaksanaan</td>
							<td valign="top">:</td>
							<td valign="top"><?php echo $dta['waktu_pelaksanaan_adendum']; ?></td>
						</tr>
		  ...
		  <?php
			...
			<?php
				...
				if($histori_ba){
					foreach($histori_ba as $rst){
						...
						<tr>
							<td width="2%">'.$nomr++.'.</td>
							<td width="27%">'.$jenis.' '.getRomawi($rst['termin']).'</td>
			...
			<table width="100%">
				...
				<tr>
					...
					<td width="40%">Rp <span class="pull-right" style="margin-right: 70px;">
					<?php 
					// echo number_format($data_pembayaran[0]->nominal_bayar, 2); 
					echo number_format($sisa_pembayaran, 2); 
					?></span></td>
					<td width="25%"></td>
				</tr>
			</table>
			...
			<?php
				if($data_pembayaran[0]->bank == 'BNI'){
					echo 'sdr.';
				}else{					
					echo 'an.';
				}
			?>  
			<?php echo @$data_pembayaran[0]->atas_nama_rekening; ?>
			<?php
