	...
	<div id="batas-margin" style="margin-bottom: 25px;">	
		<table id="table_template_bast" width="100%" style="border-collapse: collapse;" align="center">
			<tr style="text-align: center; font-weight: bold; text-align: center;">
				...
				Kegiatan : <br>
				<?php echo $data_prokeg[1]['uraian_prokeg']; ?><br>
				Sub Kegiatan : <br>
				<?php echo @$data->nama_kegiatan; ?>
				</td>
				<td id="" colspan="2" class="full kop2" style="vertical-align : middle;">BERITA ACARA <br>SERAH TERIMA <br>PEKERJAAN</td>
			</tr>
			<tr>
				...
				<td id="td_template_bast" width="35%" class="kanan"><span class="<?php if(@$data_pembayaran[0]->nomor_kosong == '0'){ echo 'nomor_kosong';} ?>"><?php echo @$data->no_bast; ?></span></td>
			</tr>
			<tr>
		...
		<table id="table_template_bast" border="0" width="100%" style="border-collapse: collapse; padding-top: 5px; padding-bottom: 5px;">
			...
			<tr>
				...
				<td id="td_template_bast">:</td>
				<td id="td_template_bast"><?php echo @$data->nomenklatur_jabatan_ppk; ?> <?php echo ucwords(getNamaUnor(substr(@$data->kode_unor,0,5))); ?> <br> Selaku Pejabat Pembuat Komitmen (PPK)</td>
			</tr>
			<tr>
				<td id="td_template_bast"></td>
		...
		<table id="table_template_bast" border="0" width="100%" style="text-align: justify;">
				...
				<td>
					<table border="0" width="100%">				
						...
						<tr>
							...
							<td id="td_template_bast">Sub Kegiatan</td>
							<td id="td_template_bast">:</td>
						...
						<tr>
							...
							<td id="td_template_bast">:</td>
							<td id="td_template_bast"><?php echo $data_prokeg[1]['uraian_prokeg']; ?></td>
						</tr>
						<tr>
							<td id="td_template_bast"><?php echo $nom++; ?>.</td>
			...
			<tr>
				...
				<td id="td_template_bast">
					...
					?>
					maka <b>PIHAK KEDUA</b> berhak menerima pembayaran dari <b>PIHAK PERTAMA</b> sebesar  Nilai Pekerjaan yaitu sebesar  <b>Rp. <?php echo number_format(@$data->nilai_pekerjaan , 2 ,',' , '.').',-'; ?> (<?php echo @$data->nilai_pekerjaan_terbilang; ?> rupiah)</b> sudah termasuk Pajak <?php if($data->kategori == 1){ echo 'PPN dan '; } ?>PPh.
				</td>
			</tr>
		</table>
		...
		<table id="table_template_bast" border="0" style="text-align: center; font-size: 10pt;" width="100%">
