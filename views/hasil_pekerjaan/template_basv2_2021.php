...
<body id="template_bas">	
	<?php if(empty(@$pdf)){?><div id="batas-margin"><?php } ?>	
		...
		PEKERJAAN <?php echo strtoupper(@$data->nama_pekerjaan); ?> 
		<br> KEGIATAN <?php echo strtoupper($data_prokeg[1]['uraian_prokeg']); ?> <br>
		SUB KEGIATAN <?php echo strtoupper(@$data->nama_kegiatan); ?> <br>
		...
		Nomor : <?php echo @$data->no_bas_penerimaan; ?>
			...
			<table id="table_template_bas" border="0" width="100%" style="border-collapse: collapse;">
				<tr>
					...
					<td id="td_template_bas" width="68%"><?php echo $data_prokeg[1]['uraian_prokeg']; ?></td>
				</tr>
				<tr>
					<td id="td_template_bas" width="30%">Sub Kegiatan</td>
					<td id="td_template_bas" width="2%">:</td>
